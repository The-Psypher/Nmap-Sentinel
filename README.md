...
<p align="center">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="160" height="160">
    ...
    <polygon points="256,30 460,140 460,372 256,482 52,372 52,140" fill="none" stroke="#22d3ee" stroke-width="4" stroke-opacity="0.2" />
    <polygon points="256,55 432,155 432,357 256,457 80,357 80,155" fill="none" stroke="url(#cyber-sun-gradient)" stroke-width="8" stroke-dasharray="24 16" />
